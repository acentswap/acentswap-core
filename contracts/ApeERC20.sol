...
contract AcentERC20 is IAcentERC20 {
    using SafeMath for uint;

    string public constant name = 'AcentSwapFinance LPs';
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'AcentSwap: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'AcentSwap: INVALID_SIGNATURE');
